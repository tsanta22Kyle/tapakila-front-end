...
function EventDetail({ id }: { id: string }) {
  ...
  useEffect(() => {
    if (data && data.data && data.data.data.length > 0) {
      ...
      if (true) {
        getImageColor( "https://img.freepik.com/vecteurs-libre/chef-orchestre-musiciens-debout-modele-flyer-plat-scene-theatre_74855-13485.jpg?t=st=1742387630~exp=1742391230~hmac=0714c3d3cf71f01223231b263310e04c62f1726bd57912c508323e99fe040d55&w=740"
  ...
  return (
    <>
      <div className={style.details}>
        ...
        <div style={{ backgroundColor: dominantColor, height: "100px", width: "100px" ,color:"white",zIndex : 1000}}>
          Couleur Dominante
        </div>
    </>
  );
